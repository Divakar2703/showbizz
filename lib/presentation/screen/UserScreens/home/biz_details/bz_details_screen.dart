...
import 'package:showbiz/presentation/controllers/user/business_details_controller.dart';
...
class BizDetails extends StatelessWidget {
  ...
  BizDetails({super.key, required this.bizId});
  final String bizId;
  final BusinessDetailsController bizDetailController =
      Get.put(BusinessDetailsController());

  @override
  StatelessElement createElement() {
    bizDetailController.getBusinessDetails(bizId);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: GetBuilder<BusinessDetailsController>(
            builder: (bizDetailController) {
          return bizDetailController.isLoading
              ...
              : Padding(
                  ...
                  child: ListView(
                    ...
                    children: [
                          ...
                          children: [
                            SizedBox(
                              ...
                              child: Container(
                                ...
                                child: Opacity(
                                    opacity: 0.8,
                                    child: bizDetailController
                                                .businessDetails!.coverImage ==
                                            null
                                        ? Image.asset(
                            ...
                            Positioned(
                              ...
                              child: Padding(
                                ...
                                child: RichText(
                                  ...
                                  text: TextSpan(
                                    text:
                                        "${bizDetailController.businessDetails!.businessName ?? 'Alpha Biz Inc'}\n",
                                    style: TextStyles.smallText.copyWith(
                                        color: white,
                                        fontWeight: FontWeight.w700),
                                    children: <TextSpan>[
                                      TextSpan(
                                          text: bizDetailController
                      ...
                      Text(
                        bizDetailController.businessDetails!.description ??
                          ...
                          return Container(
                            decoration: BoxDecoration(
                                image: const DecorationImage(
                                    image:
                                        AssetImage("asset/images/bg-image.png"),
                                    fit: BoxFit.fill),
                                borderRadius:
                                    BorderRadius.circular(card_radius / 2)),
                          );
                        },
                      ),
                      ...
                      TertiaryBtn(
                          ...
                          onTap: () {
                            Navigator.pushNamed(
                                context, InteractWithBiz.routeName);
                          }),
                      const DividerWidget(
                        height: 10,
                      ),
                      TertiaryBtn(
                        ...
                        onTap: () {
                          if (bizDetailController.liveSessions.isNotEmpty) {
                            Get.to(
                              () => NonInteractWithBiz(
                                link:
                                    bizDetailController.liveSessions.last.url!,
                              ),
                            );
                          }
                        },
