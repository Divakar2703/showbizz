...
class InteractiveSessionRequest extends StatefulWidget {
  static const String routeName = "interactive_session_request";

  const InteractiveSessionRequest({super.key});

  @override
  State<InteractiveSessionRequest> createState() =>
      _InteractiveSeesionRequestState();
}

enum InputType { search, location }

class _InteractiveSeesionRequestState extends State<InteractiveSessionRequest> {
  @override
            ...
            child: TabBar(
              ...
              tabs: const [
                Padding(
                  ...
                  child: Tab(
                    child: Text("Upcoming", style: TextStyle(fontSize: smallerFontSize, color: lightWhiteTextColor),),
                  ),
                ),
                Padding(
                  padding: EdgeInsets.symmetric(horizontal: 10.0),
                  child: Tab(
                    child: Text("Rejected", style: TextStyle(fontSize: smallerFontSize, color: lightWhiteTextColor),),
                  ),
                ),
                Padding(
                  padding: EdgeInsets.symmetric(horizontal: 10.0),
                  child: Tab(
                    child: Text("Completed", style: TextStyle(fontSize: smallerFontSize, color: lightWhiteTextColor),),
